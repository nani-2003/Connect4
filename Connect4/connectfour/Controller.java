...
public class Controller implements Initializable {
	...
	public void createPlayground() {
		...
		List<Rectangle> rectangleList=createClickableColmns();
	...
	private Shape createGameStructuralGrid() {
		...
		for (int rw = 0; rw < ROWS; rw++) {
			for (int col = 0; col < COLUMNS; col++) {
				...
				circle.setTranslateY(rw * (CIRCLE_DIAMETER + 5) + CIRCLE_DIAMETER / 4);
	...
	private List<Rectangle> createClickableColmns(){
	...
	private boolean checkCombinations(List<Point2D> points) {
		...
		for(Point2D point : points){
			...
			int columnIndecForArray= (int) point.getY();

			Disc disc=getDiscIfPresent(rowIndexForArray,columnIndecForArray);
